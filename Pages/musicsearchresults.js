...
class MusicSearchResults extends React.Component {
...
function setMusicSearch(value) {
  ...
  //var spotifyURL = 'https://api.spotify.com/json?'
  var spotifyURL = "https://api.spotify.com/v1/search?q=" + value + "&type=" + searchType;
  //var spotifyURL = 'https://api.spotify.com/v1/albums/' + encodedValue;
  axios.get(spotifyURL).then((response) => {
    artists = '';
    album = '';
    year = '';
    genres = '';
...
module.exports = {MusicSearchResults, setMusicSearch, setSearchType, reset};

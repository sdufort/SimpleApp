...
}();var _desc, _value, _class, _class2, _temp;var _react = require('react');var _react2 = _interopRequireDefault(_react);
...
var _reactNative = require('react-native');var _reactNative2 = _interopRequireDefault(_reactNative);function _interopRequireDefault(obj) {
  ...
  var desc = {};Object['ke' + 'ys'](descriptor).forEach(function (key) {
...
}var Animated = _reactNative2.default.Animated,
    ...
    View = _reactNative2.default.View;var PropTypes = _react2.default.PropTypes;
...
var SETTLING = 'Settling';var DrawerLayout = (_class = (_temp = _class2 = function (_React$Component) {
  _inherits(DrawerLayout, _React$Component);

  function DrawerLayout(props, context) {
    _classCallCheck(this, DrawerLayout);var _this = _possibleConstructorReturn(this, (DrawerLayout.__proto__ || Object.getPrototypeOf(DrawerLayout)).call(this, props, context));
    ...
    _this.state = {
      ...
      return _react2.default.createElement(View, _extends({
        style: { flex: 1, backgroundColor: 'transparent' } }, this._panResponder.panHandlers), _react2.default.createElement(Animated.View, { style: styles.main }, this.props.children), drawerShown && _react2.default.createElement(TouchableWithoutFeedback, { onPress: this._onOverlayClick }, _react2.default.createElement(Animated.View, { style: [styles.overlay, animatedOverlayStyles] })), _react2.default.createElement(Animated.View, {
        style: [styles.drawer, dynamicDrawerStyles, animatedDrawerStyles] }, this.props.renderNavigationView()));
    } }, { key: '_onOverlayClick', value: function _onOverlayClick(e) {
      e.stopPropagation();
      ...
      Animated.spring(this.state.openValue, _extends({
        toValue: 1,
        bounciness: 0,
        restSpeedThreshold: 0.1 }, options)).start(function () {
      ...
      Animated.spring(this.state.openValue, _extends({
        toValue: 0,
        bounciness: 0,
        restSpeedThreshold: 1 }, options)).start(function () {
    ...
    } }, { key: '_shouldSetPanResponder', value: function _shouldSetPanResponder(e, _ref2) {
      var moveX = _ref2.moveX,
          dx = _ref2.dx,
          dy = _ref2.dy;var drawerPosition = this.props.drawerPosition;
    ...
    } }, { key: '_panResponderMove', value: function _panResponderMove(e, _ref3) {
    ...
    } }, { key: '_panResponderRelease', value: function _panResponderRelease(e, _ref4) {
      var moveX = _ref4.moveX,
          vx = _ref4.vx;var drawerPosition = this.props.drawerPosition;
